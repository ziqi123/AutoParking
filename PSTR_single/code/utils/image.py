...
def crop_image(image, center, size):
    cty, ctx            = center # 360 640
    height, width       = size   # 767 1407
    im_height, im_width = image.shape[0:2] # 720 1280
    ...
    # print(left, right) # 640 640
    # print(top, bottom) # 360 360

    cropped_cty, cropped_ctx = height // 2, width // 2
    # print(cropped_cty, cropped_ctx) # 383 703

    y_slice = slice(cropped_cty - top, cropped_cty + bottom)
    x_slice = slice(cropped_ctx - left, cropped_ctx + right)
    # print(y_slice) # 23 743, None
    # print(x_slice) # 63 1343, None
