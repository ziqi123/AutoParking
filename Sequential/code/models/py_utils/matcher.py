...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        # 16、50
        out_prob = outputs["pred_classes"].flatten(
            0, 1).softmax(-1)
        ...
        # print('out_bbox_center', out_bbox_center.shape)
        # [800,2]
        # print('out_bbox_points', out_bbox_points.shape)
        l = []
        ...
        # print('tgt_bbox_center', tgt_bbox_center.shape)
        # [78, 2]
        # print('tgt_bbox_points', tgt_bbox_points.shape)
        # [78, 8]
