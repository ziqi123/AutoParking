...
#     # # 将384*384图片上的真值点经仿射变换矩阵映射到原图上，检测变换是否正确
...
# #             "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/src_img", i)
# #         # 仿射变换矩阵
# #         trans_inv = os.path.join(
# #             "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/trans_inv", i.strip('.jpg')+'.txt')
# #         # 将384*384图片上真值点映射到原图上
# #         fina_path = os.path.join(
# #             "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/fina", i)
# #         # 原图真值点坐标
# #         annt_path2 = os.path.join(
# #             '/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/annotation', i.strip('.jpg')+'_OA.txt')
# #         # 384*384图片上的真值点
# #         point_path = os.path.join(
# #             "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/point", i.strip('.jpg')+'_OA.txt')
# #         # print(fina_path)
...
#     save_path_annt = "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/annt"
...
if __name__ == "__main__":
    ...
    save_path1 = "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/src_img"
    save_path2 = "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/perspective2_img"
    annt_path_new = "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_TrainingDaraSet_All/annt"
