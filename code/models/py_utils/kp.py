...
from .matcher4 import build_matcher4
from .matcher5 import build_matcher5
from .matcher6 import build_matcher6

from .matcher3 import build_matcher3
...
class AELoss(nn.Module):
    def __init__(self,
        ...
        losses = ['cls', 'joints', 'box', 'class']
        self.debug_path = debug_path
        self.matcher = build_matcher(1, 1, 3, bsize)
        self.matcher2 = build_matcher2(1, 1, 3, bsize)
        self.matcher3 = build_matcher3(1, 1, 3, bsize)
        self.matcher4 = build_matcher4(1, 1, 3, bsize)
        self.matcher5 = build_matcher5(1, 1, 3, bsize)
        self.matcher6 = build_matcher6(1, 1, 3, bsize)
        self.criterion = SetCriterion(num_classes=2,
                                      matcher=self.matcher,
                                      matcher2=self.matcher2,
                                      matcher3=self.matcher3,
                                      matcher4=self.matcher4,
                                      matcher5=self.matcher5,
                                      matcher6=self.matcher6,
    ...
    def forward(self,
        ...
        # print('oss_dict[k]', loss_dict['loss_ce'])
