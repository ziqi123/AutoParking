...
def get_accuracy(pix):
    accuracy = 0
    for i in os.listdir(mark_test_img_384_dir):
...
if __name__ == "__main__":
    trans_inv_dir = "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_Training_TestSet_v1.0.7_All_3342/trans_inv"
    src_img_1024_dir = "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_Training_TestSet_v1.0.7_All_3342/src_img"
    annt_1024_dir = "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_Training_TestSet_v1.0.7_All_3342/annt"
    mark_img_1024_dir = "/media/home_bak/ziqi/park/Ps_locate_dataset/PLD_BirdView_Training_TestSet_v1.0.7_All_3342/fina2"
    ...
    for i in os.listdir(mark_test_img_384_dir):
        output_path = os.path.join(
            point_pred_384_dir, i.strip('.jpg')+'.txt')
        src_img_1024_path = os.path.join(src_img_1024_dir, i)
        ...
        point_384_gt_path = os.path.join(
            point_384_gt_dir, i.strip('.jpg')+'.txt')
        point_pred_1024_path = os.path.join(
            point_pred_1024_dir, i.strip('.jpg')+'.txt')
        point_gt_1024_path = os.path.join(
            point_gt_1024_dir, i.strip('.jpg')+'.txt')
    ...
    # 计算1024*1024图片上角度的精度
    for pix in range(10):
        for c in os.listdir(mark_test_img_384_dir):
            point_pred_1024_path = os.path.join(
    ...
    for y in range(10):
        accuracy_angle[y] = 100 * accuracy_angle[y] / 6842
