...
if __name__ == "__main__":
    data_dir = '/media/home_bak/ziqi/park/single_pic/test/pic'
    point_dir = '/media/home_bak/ziqi/park/single_pic/test/point'
    save_dir = '/media/home_bak/ziqi/park/single_pic/test/pic_crop'
    point_crop_dir = '/media/home_bak/ziqi/park/single_pic/test/point_crop'
    path_record = '/media/home_bak/ziqi/park/single_pic/test/path_record.txt'
