...
if __name__ == "__main__":
    data_dir = '/media/home_bak/ziqi/park/single_pic/test2/pic'
    point_dir = '/media/home_bak/ziqi/park/single_pic/test2/point'
    save_dir = '/media/home_bak/ziqi/park/single_pic/test2/pic_crop'
    point_crop_dir = '/media/home_bak/ziqi/park/single_pic/test2/point_crop'
    path_record = '/media/home_bak/ziqi/park/single_pic/test2/path_record.txt'
