...
#         # 16,50
#         # print('bs, num_queries', bs, num_queries)
#         out_prob = outputs["pred_class"].flatten(
#             0, 1).flatten(0, 1).softmax(-1)
#         # print('out_prob', out_prob.shape)
#         # [40000, 6]
#         out_bbox = outputs["pred_box"].flatten(
#             0, 1) .flatten(0, 1)  # [batch_size * num_queries, 10]
...
#         cost_bbox_points = torch.cdist(out_bbox, tgt_bbox, p=1)
#         # print('cost_bbox_points', cost_bbox_points.shape)
#         # print('cost_class', cost_class.shape)
#         # [40000, 63]
...
#         C = self.cost_bbox_points*cost_bbox_points+self.cost_class*cost_class
#         # print('C', C.shape)
...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        # [batch_size * num_queries, num_classes]
        out_prob = outputs["pred_classes"].flatten(0, 1).softmax(-1)
