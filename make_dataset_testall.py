...
if __name__ == "__main__":
    data_dir = '/media/home_bak/ziqi/park/single_pic/test_all/pic'
    point_dir = '/media/home_bak/ziqi/park/single_pic/test_all/point'
    save_dir = '/media/home_bak/ziqi/park/single_pic/test_all/pic_crop'
    point_crop_dir = '/media/home_bak/ziqi/park/single_pic/test_all/point_crop'
    path_record = '/media/home_bak/ziqi/park/single_pic/test_all/path_record.txt'
